...
export const metadata: Metadata = {
  title: "Dina Valisoa RANDRIAMIFIDY — Fullstack Developer & AI Engineer",
  description: "Portfolio of Dina Valisoa RANDRIAMIFIDY, Fullstack Developer and AI Engineer based in Madagascar and France.",
  generator: "v0.app",
}
