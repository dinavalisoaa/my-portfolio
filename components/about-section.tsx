      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
        <div className="flex justify-center">
          <div className="relative w-full max-w-lg aspect-square border-[4px] border-black rounded-full overflow-hidden bg-[#FF6B6B] shadow-[-8px_8px_0px_0px_rgba(0,0,0,1)]">
            <Image src="/images/2.png" alt="About me illustration" fill className="object-cover" />
          </div>
        </div>
        ...
        <div className="space-y-6 md:space-y-8">
          <div>
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
              Friendly, autonomous, and serious developer who acquires new skills rapidly. Bilingual in English and French, passionate about tech, and driven to lead impactful projects.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-bold mb-2">4+ years of professional experience</h3>
                <p className="text-gray-600 text-sm md:text-base">
                  From Java/JEE banking apps to AI-powered accessibility tools and FinTech payment platforms.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-bold mb-2">10+ technologies mastered</h3>
                <p className="text-gray-600 text-sm md:text-base">
                  Java Spring, Next.js, Python, TypeScript, Odoo, FastAPI, LLMs, Docker, PostgreSQL, and more.
                </p>
              </div>
            </div>
          </div>
