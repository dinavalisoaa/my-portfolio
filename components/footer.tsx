      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-lg md:text-xl font-bold">Dina Valisoa R.</span>
              </div>
              <p className="text-gray-400 mb-6 text-sm leading-relaxed">
                Fullstack Developer &amp; AI Engineer. Building FinTech platforms, AI tools, and ERP systems.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400 text-sm">
                <li className="flex items-center gap-2">
                  ...
                  <a href="mailto:randriamifydina@gmail.com" className="hover:text-white transition-colors">
                    randriamifydina@gmail.com
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            <p>Portfolio of Dina Valisoa RANDRIAMIFIDY</p>
          </div>
        </div>
      </div>
    </footer>
