    ...
    <section className="container mx-auto px-4 py-16 md:py-24">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h1 className="text-[32px] leading-[42px] md:text-[52px] font-bold md:leading-[64px]">
            I'm <span className="bg-[#FF6B7A] text-white px-3 py-1 inline-block">Dina V. Randriamifidy</span>, a Software Engineer
          </h1>

          <p className="text-[#393939] text-[16px] md:text-[18px] font-medium leading-[28px] md:leading-[30px] max-w-xl">
            Passionate fullstack developer and AI engineer with 4+ years of experience building FinTech platforms, ERP systems, and AI-powered applications. Currently pursuing Master II MIAGE MBDS at Université de Côte d'Azur.
          </p>
